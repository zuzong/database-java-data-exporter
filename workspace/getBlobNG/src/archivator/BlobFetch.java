...
public class BlobFetch {
	...
	public static void main(String[] args) {
		...
		String col = JOptionPane.showInputDialog("Tast inn navn på kolonnen der\ndokumentene ligger", "");
		String idx = JOptionPane.showInputDialog("Tast inn navn på kolonnen som inneholder\nløpenummer for dokumentene.\n\nDette nummeret benyttes som filnavn.", "");
